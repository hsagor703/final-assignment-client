  ...
  const steps = [
    {
      ...
      description:
        "Create an account and set up your organization details within minutes.",
    },
    {
      icon: <Users className="w-10 h-10 text-blue-600" />,
      title: "Add Employees & Assets",
      description:
        "Easily assign assets, manage teams, and track everything in one dashboard.",
    },
    {
      icon: <CheckCircle className="w-10 h-10 text-blue-600" />,
      title: "Manage & Monitor",
      description:
        "Monitor asset usage, approvals, and requests with real-time updates.",
    },
  ];
